...
st.write(
    "Analyze your resume against multiple German job descriptions using AI."
)
...
if st.button(
    ...
    with st.spinner("Reading resume..."):
        ...
        resume = ResumeReader.read_pdf(
            resume_file
        )

    with st.spinner("Loading jobs..."):

        jobs = JobLoader.load_jobs(
            job_files
        )
...
# ==========================
    ...
    selected_jobs = [
        job
        for job in jobs
        if job["name"] in selected_company_names
    ]
